...
TPHXTimer = class(TObject)
  ...
  public
   ...
   // Updates the timer
    ...
    // Эта функция измеряет время, прошедшее между двумя вызовами функции
    function MeasureTime: Double;

    // The interval of the timer, in seconds. If zero then max speed.
    //Интервал таймера в секундах. Если ноль, то максимальная скорость.
